...
// Authenticate provides a mock function for the type MockSecurityHandlerService
func (_mock *MockSecurityHandlerService) Authenticate(ctx context.Context, accessToken string) (*models.AccessTokenClaims, error) {
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) (*models.AccessTokenClaims, error)); ok {
		return returnFunc(ctx, accessToken)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) *models.AccessTokenClaims); ok {
...
func (_c *MockSecurityHandlerService_Authenticate_Call) Return(accessTokenClaims *models.AccessTokenClaims, err error) *MockSecurityHandlerService_Authenticate_Call {
	_c.Call.Return(accessTokenClaims, err)
	return _c
}

func (_c *MockSecurityHandlerService_Authenticate_Call) RunAndReturn(run func(ctx context.Context, accessToken string) (*models.AccessTokenClaims, error)) *MockSecurityHandlerService_Authenticate_Call {
	_c.Call.Return(run)
	return _c
}
