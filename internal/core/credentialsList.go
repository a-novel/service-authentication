...
type CredentialsListDao interface {
...
func NewCredentialsList(dao CredentialsListDao) *CredentialsList {
...
func (service *CredentialsList) Exec(
	...
	entities, err := service.dao.Exec(ctx, &dao.CredentialsListRequest{
		Limit:  request.Limit,
