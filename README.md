...
services:
  postgres-authentication:
    image: ghcr.io/a-novel/service-authentication/database:v2.2.4
    networks:
      - api
    environment:
  ...
  service-authentication:
    image: ghcr.io/a-novel/service-authentication/standalone:v2.2.4
    ports:
      - "4011:8080"
    depends_on:
      postgres-authentication:
...
services:
  ...
  migrations-authentication:
    image: ghcr.io/a-novel/service-authentication/migrations:v2.2.4
    depends_on:
      postgres-authentication:
        condition: service_healthy
    environment:
  ...
  init-authentication:
    image: ghcr.io/a-novel/service-authentication/init:v2.2.4
    depends_on:
      postgres-authentication:
        condition: service_healthy
      migrations-authentication:
  ...
  service-authentication:
    image: ghcr.io/a-novel/service-authentication/rest:v2.2.4
    ports:
      - "4011:8080"
    depends_on:
      postgres-authentication:
