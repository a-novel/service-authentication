...
services:
  postgres-authentication:
    image: ghcr.io/a-novel/service-authentication/database:v2.5.3
    networks: [api]
    environment:
  ...
  service-authentication:
    image: ghcr.io/a-novel/service-authentication/rest:v2.5.3
...
services:
  ...
  service-authentication:
    image: ghcr.io/a-novel/service-authentication/standalone-rest:v2.5.3
    ports: ["${SERVICE_AUTHENTICATION_REST_PORT}:8080"]
    depends_on:
      postgres-authentication: { condition: service_healthy }
    environment:
