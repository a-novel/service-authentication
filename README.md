...
services:
  postgres-authentication:
    image: ghcr.io/a-novel/service-authentication/database:v2.4.0
    networks:
      - api
    environment:
  ...
  service-authentication:
    image: ghcr.io/a-novel/service-authentication/standalone:v2.4.0
    ports:
...
services:
  ...
  migrations-authentication:
    image: ghcr.io/a-novel/service-authentication/migrations:v2.4.0
    depends_on:
      postgres-authentication:
        condition: service_healthy
    environment:
  ...
  init-authentication:
    image: ghcr.io/a-novel/service-authentication/init:v2.4.0
    depends_on:
      postgres-authentication:
        condition: service_healthy
      migrations-authentication:
  ...
  service-authentication:
    image: ghcr.io/a-novel/service-authentication/rest:v2.4.0
    ports:
      - "${SERVICE_AUTHENTICATION_REST_PORT}:8080"
    depends_on:
      postgres-authentication:
